	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="CitedConferences.php" accesskey="5" title="">Most Cited Conferences</a></li>
 ...
 $(document).ready(function(){  
      ...
      {  
           $.ajax({  
                url:"pagination.php",  
                method:"POST",  
                data:{page:page,type:'conferences',eval:'cite'},  
